...
public record PythonFunctionNode(
    ...
    public static Builder builder() {
        return new Builder("f", P.vector(), P.vector(), P.vector(), P.vector());
    }
    ...
    public record Builder(
        ...
        public PythonFunctionNode build() {
            return new PythonFunctionNode(name, decorators, positionalParams, keywordParams, body);
        }

        public Builder name(String name) {
            return new Builder(name, decorators, positionalParams, keywordParams, body);
        }

        public Builder addDecorator(PythonExpressionNode decorator) {
            return new Builder(name, decorators.plus(decorator), positionalParams, keywordParams, body);
        }

        public Builder addPositionalParam(String param) {
            return new Builder(name, decorators, positionalParams.plus(param), keywordParams, body);
        }

        public Builder addKeywordParam(String param) {
            return new Builder(name, decorators, positionalParams, keywordParams.plus(param), body);
        }

        public Builder addBodyStatement(PythonStatementNode statement) {
            return new Builder(name, decorators, positionalParams, keywordParams, body.plus(statement));
        }
    }
}
