...
public class TypeScriptCodeGeneratorMemberReferenceTests {
    @Test
    public void memberReferenceIsCompiledToPropertyAccessOnThis() {
        ...
        assertThat(string, equalTo("this.value"));
    }
}
